...
<html>
<head>
  <title>User List - EnetCapture</title>
  <meta charset="UTF-8">
...
<section class="gradient-overlay py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white bg-opacity-90 p-8 rounded-lg shadow-md">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full border border-gray-300">
          ...
          <tr>
            ...
            <th class="border-b px-4 py-2 text-left text-gray-700">Full Name</th>
          ...
          <c:forEach var="user" items="${users}">
            <tr class="hover:bg-gray-50">
              ...
              <td class="border-b px-4 py-2">${user.fullName}</td>
              <td class="border-b px-4 py-2">
                <a href="${pageContext.request.contextPath}/users/edit?username=${user.username}" class="bg-blue-600 text-white px-3 py-1 rounded-lg hover:bg-blue-700 transition">Edit</a>
                <a href="${pageContext.request.contextPath}/users/delete?username=${user.username}" class="bg-red-600 text-white px-3 py-1 rounded-lg hover:bg-red-700 transition" onclick="return confirm('Are you sure?')">Delete</a>
              </td>
            </tr>
          </c:forEach>
          </tbody>
      ...
      <a href="${pageContext.request.contextPath}/adminDashboard" class="block mt-6 text-blue-600 hover:underline">Back to Dashboard</a>
    </div>
  </div>
</section>
