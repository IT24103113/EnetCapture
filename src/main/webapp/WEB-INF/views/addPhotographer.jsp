...
<html>
<head>
    <title>Add Photographer - EnetCapture</title>
    <meta charset="UTF-8">
...
<section class="gradient-overlay py-16">
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white bg-opacity-90 p-8 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Add Photographer</h2>
            ...
            <form action="${pageContext.request.contextPath}/photographers/add" method="post">
                ...
                <div class="mb-6">
                    ...
                    <input type="number" id="rating" name="rating" step="0.1" min="0" max="5" required class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                </div>
                <button type="submit" class="w-full bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 transition">Add Photographer</button>
            </form>
            <a href="${pageContext.request.contextPath}/photographers" class="block text-center mt-4 text-blue-600 hover:underline">Back to Photographers</a>
        </div>
    </div>
</section>
