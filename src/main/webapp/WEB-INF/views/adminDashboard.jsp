...
<html>
<head>
    <title>Admin Dashboard - EnetCapture</title>
    <meta charset="UTF-8">
        ...
        <div class="bg-white bg-opacity-90 p-8 rounded-lg shadow-md">
            ...
            <div class="mb-12">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="${pageContext.request.contextPath}/register" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">Add User</a>
                </div>
                <c:choose>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full border-collapse">
                                ...
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="border border-gray-300 p-3 text-left">Full Name</th>
                                ...
                                <c:forEach var="user" items="${users}">
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 p-3">
                                            <a href="${pageContext.request.contextPath}/users/edit?username=${user.username}" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Edit</a>
                                            <a href="${pageContext.request.contextPath}/users/delete?username=${user.username}" class="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700" onclick="return confirm('Are you sure?')">Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
            ...
            <div>
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-2xl font-semibold text-gray-800">Admins</h3>
                    <a href="${pageContext.request.contextPath}/admins/add" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">Add Admin</a>
                </div>
                <c:choose>
