...
<html>
<head>
    <title>Admin Login - EnetCapture</title>
    <meta charset="UTF-8" />
...
<section class="gradient-overlay py-16" data-aos="fade-up">
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white bg-opacity-90 p-8 rounded-lg shadow-md pop-animation">
            ...
            <a href="${pageContext.request.contextPath}/admin/register" class="block text-center mt-4 text-blue-600 hover:underline">Add Admin</a>
        </div>
    </div>
</section>
