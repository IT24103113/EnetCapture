...
<html>
<head>
    <title>Edit User - EnetCapture</title>
    <meta charset="UTF-8">
        ...
        <div class="bg-white bg-opacity-90 p-8 rounded-lg shadow-md">
            ...
            <form action="${pageContext.request.contextPath}/users/edit" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" value="${user.username}" readonly class="w-full p-3 border border-gray-300 rounded-lg bg-gray-100">
                </div>
                <div class="mb-4">
                    <label for="fullName" class="block text-gray-700 font-medium mb-2">Full Name</label>
                    <input type="text" id="fullName" name="fullName" value="${user.fullName}" required class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" value="${user.email}" required class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                </div>
                <div class="mb-4">
                    <label for="phone" class="block text-gray-700 font-medium mb-2">Phone</label>
                    <input type="text" id="phone" name="phone" value="${user.phone}" required class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                </div>
                <button type="submit" class="w-full bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 transition">Update User</button>
            </form>
            <a href="${pageContext.request.contextPath}/users" class="block text-center mt-4 text-blue-600 hover:underline">Back to Users</a>
        </div>
    </div>
</section>
